...
export const triptych = [
    ...
    { src: '/images/gallery/umang-parents-tribute.jpg', capHi: 'सेवा', capEn: 'The Mission', link: '/about#mission', imagePosition: '79% center' },
];
...
export const pressHighlights = [
    ...
    { src: '/images/gallery/microtec-office-opening.jpg', badge: 'उद्घाटन', badgeEn: 'Grand Opening', capHi: 'माइक्रोटेक ग्रुप ऑफ इंस्टीट्यूशंस के नए हेड ऑफिस के भव्य उद्घाटन में डॉ. उमंग नाथ शर्मा', capEn: "Dr. Umang Nath Sharma at the Grand Opening of MicroTec Group of Institutions' new Head Office" },
