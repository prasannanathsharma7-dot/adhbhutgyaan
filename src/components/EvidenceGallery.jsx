...
// Accessible photo-lightbox for showing press clippings / credentials at
// full size without cropping. This is the one piece kept from a batch of
// AI (ChatGPT/Codex) changes to the site that were otherwise reverted -
// evaluated on its own merits (keyboard nav, focus management, ARIA
// labelling, body-scroll lock while open) and found genuinely well built.
    ...
    return (
        <>
            ...
            {mobileRail && items.length > 1 && (
                <p className="evidence-swipe-hint" aria-hidden="true">
