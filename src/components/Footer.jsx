                ...
                <div className="footer-grid">
                    <div className="footer-brand">
                        ...
                        <div className="footer-social">
                            ...
                            <a href="https://wa.me/919818227189" target="_blank" rel="noreferrer" className="social-link whatsapp" aria-label="WhatsApp">
                            ...
                            <a href="tel:+919818227189" className="social-link phone" aria-label={t('कॉल करें', 'Call')}>
