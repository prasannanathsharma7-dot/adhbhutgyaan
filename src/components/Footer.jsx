...
import { Home, Sunrise, CalendarDays, Sparkles, User, FileText, Phone, MapPin, MessageCircle, Mail, Store } from 'lucide-react';
                ...
                <div className="footer-grid">
                    <div className="footer-brand">
                        ...
                        <div className="footer-social">
                            <a href="https://www.facebook.com/share/1ELXmyQUWx/" target="_blank" rel="noreferrer" className="social-link facebook" aria-label="Facebook">
                            ...
                            <a href="https://www.justdial.com/Varanasi/Pt-Umang-Nath-Sharma-Naibasti-Nati-Imli/0542PX542-X542-221231232206-Q8Q2_BZDET" target="_blank" rel="noreferrer" className="social-link justdial" aria-label="JustDial">
                                <Store size={18} />
                            </a>
