 ...
 */
export function computePanchadhaMaitri(planetSigns) {
    const table = {};
...
export function maitriLabel(tier, lang = 'hi') {
 ...
 * affliction).
 */
export function evaluateManglik(marsHouse, marsSign, jupiterAspectsMars = false) {
 ...
 */
export function combinedManglikVerdict(fromLagna, fromMoon, fromVenus) {
 ...
 */
export function isCombust(planetKey, sunLongitude, planetLongitude, isRetrograde = false) {
