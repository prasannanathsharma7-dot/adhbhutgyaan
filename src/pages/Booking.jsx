                            ...
                            {saveStatus === 'saved' && (
                                <div style={{ textAlign: 'center', color: 'var(--whatsapp)', margin: '0 auto 1rem', maxWidth: 600 }} role="status">
                                    <p style={{ fontSize: '0.85rem', marginBottom: bookingReference ? '0.45rem' : 0 }}>
                                        <CheckCircle2 size={14} style={{ verticalAlign: '-2px', marginRight: '0.3rem' }} />{t('आपकी पूछताछ सुरक्षित रूप से दर्ज हो गई है। हमारी टीम 24 घंटे के भीतर WhatsApp या कॉल पर संपर्क करेगी।', 'Your enquiry has been securely recorded. Our team will contact you by WhatsApp or phone within 24 hours.')}
                                    </p>
                                    {bookingReference && (
